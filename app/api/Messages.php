...
Class Messages {
	...
	*/
	...
	public function getConversations($id){
		...
		$query = "SELECT ml.lastMessage, ml.lastMessageDate, ml.messageStatus,u.username,u.photo FROM messageslist ml, users u WHERE ml.userId=".$id." and u.id = ml.toId order by id desc";
